var rule = {
	...
	timeout: 5000,
	class_name: '热门影&热播剧&热播综&电影筛选&电视筛选&电影榜&电视榜',
		...
		'show_hot': [
			{
				...
				'value': [
					{'n': '综合','v': 'show_hot'},
					{'n': '国内综艺','v': 'show_domestic'},
					{'n': '国外综艺','v': 'show_foreign'}]
			}
		],
		'movie': [
			{
		...
		'rank_list_movie': [
			{
				...
				'name': '榜单',
				'value': [
					{'n': '实时热门榜','v': 'movie_real_time_hotest'},
					{'n': '一周口碑榜','v': 'movie_weekly_best'},
					{'n': '豆瓣Top250','v': 'movie_top250'}]
			}
		],
		'rank_list_tv': [
			{
				...
				'name': '榜单',
				'value': [
					{'n': '实时热门剧集','v': 'tv_real_time_hotest'},
					{'n': '华语口碑剧集','v': 'tv_chinese_best_weekly'},
					{'n': '全球口碑剧集','v': 'tv_global_best_weekly'},
					{'n': '国内口碑综艺','v': 'show_chinese_best_weekly'},
					{'n': '国外口碑综艺','v': 'show_global_best_weekly'}]
			}
		]
	},
	limit: 20,
